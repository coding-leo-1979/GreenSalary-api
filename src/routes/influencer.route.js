...
const { inputCode, readContract, joinContract, readContracts, inputURL, readURL, ask, readMypage, updateMypageProfile, updateMypagePassword } = require('../controllers/influencer.controller');
...
router.post('/ask/:joinId', verifyToken, verifyRole('influencer'), ask);
